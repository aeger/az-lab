export const config = {
  ...
  ha: {
    ...
    pollInterval: parseInt(process.env.POLL_HA || '15000', 10),
  },
  ...
  discord: {
    ...
    // Daily digest: post a summary to Discord each morning
  ...
  nemotron: {
    url: process.env.NEMOTRON_URL || 'http://192.168.1.183:8000',
